...
class ColorsNew:
    def build_frame(self, father_frame):
        ...
        calibrateBtn = tk.Button(self.master, text="Calibrate", bg='yellow', fg="black", command=self.calibrate)
        calibrateBtn.pack()
        findColorBtn = tk.Button(self.master, text="Find Color", bg='yellow', fg="black", command=self.findColor)
        findColorBtn.pack()
        stopFindColorBtn = tk.Button(self.master, text="Stop Finding Color", bg='yellow', fg="black", command=self.stopFindingColor)
        stopFindColorBtn.pack()
